...
starting from your buildout directory::
    ...
    cd src/nva.folderbehaviors/src
    ../../../bin/paster add --list
...
nva, and inside that, the package heart: folderbehaviors.

Inside src/nva/folderbehaviors:
...
run all your package tests with the command::
    ...
    bin/test -s nva.folderbehaviors
